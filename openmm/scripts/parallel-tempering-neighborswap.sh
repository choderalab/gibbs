...
#PBS -o parallel-tempering-neighborswap.stdout
#
# filename for standard error (default = <job_name>.e<job_id>)
# at end of job, it is in directory from which qsub was executed
# remove extra ## from the line below if you want to name your own file
#PBS -e parallel-tempering-neighborswap.stderr
...
#rm -f data/parallel-tempering-neighborswap.nc

#python parallel-tempering.py neighborswap > parallel-tempering-neighborswap.out
#python parallel-tempering.py neighborswap 
...
mpirun -machinefile ${PBS_NODEFILE} -np ${NP} python parallel-tempering.py neighborswap 
