...
#PBS -o parallel-tempering-allswap.stdout
#
# filename for standard error (default = <job_name>.e<job_id>)
# at end of job, it is in directory from which qsub was executed
# remove extra ## from the line below if you want to name your own file
#PBS -e parallel-tempering-allswap.stderr
...
rm -f data/parallel-tempering-allswap.nc

#python parallel-tempering.py allswap > parallel-tempering-allswap.out
#python parallel-tempering.py allswap 
...
mpirun -machinefile ${PBS_NODEFILE} -np ${NP} python parallel-tempering.py allswap 
